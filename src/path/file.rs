...
mod tests {
    ...
    fn test_format_path_file() {
        let formatted = format_path_file("/usr/bin:/bin:/usr/local/bin");
    ...
    fn test_parse_legacy_format() {
        let parsed = parse_path_file("/usr/bin:/bin:/usr/local/bin").unwrap();
